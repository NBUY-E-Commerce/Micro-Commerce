...
namespace B_Commerce.ProductService.Migrations
{
    ...
    [Migration("20191120210259_Model Readjusment(Simple Tables)-Added MasterCategory Table")]
    partial class ModelReadjusmentSimpleTablesAddedMasterCategoryTable
    {
            ...
            modelBuilder.Entity("B_Commerce.ProductService.DomainClasses.Product", b =>
                {
                    ...
                    b.Property<bool>("isActive")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ActiveProduct")
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("isDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DeletedProduct")
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("B_Commerce.ProductService.DomainClasses.ProductImage", b =>
                {
                    ...
                    b.Property<bool>("isActive")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ActiveImage")
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("isDeleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DeletedImage")
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
